...
class Page {
    ...
    public function show() {
        ...
        if ($upRow>0){
            $upPage     =   "<a href='".str_replace('__PAGE__',$upRow,$url)."' class='paging-prev'>".$this->config['prev']."</a>";
        }else{
            $upPage = '';
        ...
        if ($downRow <= $this->totalPages){
            $downPage   =   "<a href='".str_replace('__PAGE__',$downRow,$url)."' class='paging-next'>".$this->config['next']."</a>";
        }else{
            $downPage = '';
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                if($page<=$this->totalPages){
                    $linkPage .= "<a href='".str_replace('__PAGE__',$page,$url)."' class='paging-number'>".$page."</a>";
                }else{
                    break;
                }
            }else{
