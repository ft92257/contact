...
class Image
{
    ...
    static function thumb($image, $thumbname, $type = '', $maxWidth = 200, $maxHeight = 50, $interlace = true)
    {
        ...
        if ($info !== false) {
            ...
            chmod($thumbname, 0666);//设置为其他用户可读
            return $thumbname;
        }
    ...
    static function buildString($string, $rgb = array(), $filename = '', $type = 'png', $disturb = 1, $border = true)
    {
        ...
        if (!empty($disturb)) {
            ...
            if ($disturb = 1 || $disturb = 3) {
                ...
                for ($i = 0; $i < 10; $i++) {
                    imagearc($im, mt_rand(-10, $width), mt_rand(-10, $height), mt_rand(30, 300), mt_rand(20, 200), 55,
                        44, $pointColor);
                }
            }
        }
     ...
     * @return string
     */
    static function buildImageVerify(
        $length = 4,
        $mode = 1,
        $type = 'png',
        $width = 48,
    ...
    static function GBVerify(
        ...
        for ($i = 0; $i < $length; $i++) {
            ...
            imagettftext($im, mt_rand(16, 20), mt_rand(-60, 60), 40 * $i + 20, mt_rand(30, 35), $fontcolor, $fontface,
                $codex);
        }
        Image::output($im, $type);
    }
        ...
        if ($info !== false) {
            ...
            for ($y = 0; $y < $dy; $y++) {
                for ($x = 0; $x < $dx; $x++) {
                    ...
                    $out .= sprintf('<span style="margin:0px;color:#%02x%02x%02x">' . $str . '</span>', $rgb['red'],
                        $rgb['green'], $rgb['blue']);
                }
                $out .= "<br>\n";
            }
